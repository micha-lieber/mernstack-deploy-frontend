...
function Edituser() {
  ...
  function getsingledata() {
    axios
      .get(`https://mernstack-deploy-backend.onrender.com/getsingleuser/${id}`)
      .then((res) => {
        setnewdata({
          Name: res.data.name,
  ...
  function submitHandler(e) {
    ...
    try {
      axios.put(
        `https://mernstack-deploy-backend.onrender.com/Edit/${id}`,
        updatedData
      );
      setnewdata({
        Name: "",
  ...
  function deleteuser() {
    try {
      axios.delete(
        `https://mernstack-deploy-backend.onrender.com/deleteuser/${id}`
      );
